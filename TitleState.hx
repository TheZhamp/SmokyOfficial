...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(["Redshot Studios"]);
				...
				// credTextShit.screenCenter();
				case 12:
					createCoolText(["sicckest mod"]);
				case 13:
					addMoreText("of the year");
				case 17:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 20:
					addMoreText('Smoky'); // credTextShit.text += '\nFunkin';
